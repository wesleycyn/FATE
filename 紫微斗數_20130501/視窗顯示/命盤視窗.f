...
\
	...
	:CLASS 命盤視窗 <SUPER Window


        :M On_Init:     ( -- )

			命盤選單 SetMenuBar: self        

                self                Start: Edit_姓名
                        BS_CENTER          +Style: Edit_姓名
                        175 175 100 20          Move: Edit_姓名
                        姓名 count          SetText: Edit_姓名 


                self Start: CbList_男女
                     275 175 100 100 Move: CbList_男女 ( x y w h ) 
                     0 0 CB_RESETCONTENT GetID: CbList_男女 SendDlgItemMessage: self drop
                     z" 先生"  ( REL>ABS )  0 CB_ADDSTRING GetID: CbList_男女 SendDlgItemMessage: self drop                               
                     z" 小姐"  ( REL>ABS )  0 CB_ADDSTRING GetID: CbList_男女 SendDlgItemMessage: self drop
                     0 男女 CB_SETCURSEL    GetID: CbList_男女 SendDlgItemMessage: self drop
         
                self                Start: Group_1
                175 300 265 120         Move: Group_1
					本命命盤 ID_命盤 =
					if 
						s" 生時變更"        SetText: Group_1
					else
                    	s" 流時變更"        SetText: Group_1
                    then
                ...
                self Start: CbList_紀元
					...
					本命命盤 ID_命盤 =
					if 
						0 紀元 CB_SETCURSEL    GetID: CbList_紀元 SendDlgItemMessage: self drop
					else
                    	z" 年歲"  ( REL>ABS )  0 CB_ADDSTRING GetID: CbList_紀元 SendDlgItemMessage: self drop
                    	0 流紀元 CB_SETCURSEL    GetID: CbList_紀元 SendDlgItemMessage: self drop
					then
                ...
                self Start: CbList_千年
                    ...
                    本命命盤 ID_命盤 =
                    if
                     	0 千年 CB_SETCURSEL    GetID: CbList_千年 SendDlgItemMessage: self drop
					else
                     	0 流千年 CB_SETCURSEL    GetID: CbList_千年 SendDlgItemMessage: self drop					
					then
                ...
                self Start: CbList_百年
                    ...
                    本命命盤 ID_命盤 =
                    if
                     	0 百年 CB_SETCURSEL    GetID: CbList_百年 SendDlgItemMessage: self drop
					else
                     	0 流百年 CB_SETCURSEL    GetID: CbList_百年 SendDlgItemMessage: self drop					
					then
...
\ )                   本命命盤 ID_命盤 =
                    if
                     	0 十年 CB_SETCURSEL    GetID: CbList_十年 SendDlgItemMessage: self drop
					else
                     	0 流十年 CB_SETCURSEL    GetID: CbList_十年 SendDlgItemMessage: self drop					
					then
...
\ )                   本命命盤 ID_命盤 =
                    if
                     	0 年 CB_SETCURSEL    GetID: CbList_年 SendDlgItemMessage: self drop
					else
                     	0 流年 CB_SETCURSEL    GetID: CbList_年 SendDlgItemMessage: self drop					
					then
                ...
                self Start: CbList_曆法
                    ...
                    本命命盤 ID_命盤 =
                    if
                     	0 曆法 CB_SETCURSEL    GetID: CbList_曆法 SendDlgItemMessage: self drop
					else
                     	0 流曆法 CB_SETCURSEL    GetID: CbList_曆法 SendDlgItemMessage: self drop					
					then						
                self Start: CbList_月
                    ...
                    本命命盤 ID_命盤 =
                    if
                     	0 月 CB_SETCURSEL    GetID: CbList_月 SendDlgItemMessage: self drop
					else
                     	0 流月 CB_SETCURSEL    GetID: CbList_月 SendDlgItemMessage: self drop					
					then
                self Start: CbList_日
                     320 350 90 200 Move: CbList_日 ( x y w h ) 
                              0 0 CB_RESETCONTENT GetID: CbList_日 SendDlgItemMessage: self drop
                                ...
                                z"   二十日"  ( REL>ABS )  0 CB_ADDSTRING GetID: CbList_日 SendDlgItemMessage: self drop
                    ...
                    本命命盤 ID_命盤 =
                    if
                     	0 日 CB_SETCURSEL    GetID: CbList_日 SendDlgItemMessage: self drop
					else
                     	0 流日子 CB_SETCURSEL    GetID: CbList_日 SendDlgItemMessage: self drop					
					then
                ...
                self Start: CbList_時
                    ...
                    本命命盤 ID_命盤 =
                    if
                     	0 時 CB_SETCURSEL    GetID: CbList_時 SendDlgItemMessage: self drop
					else
                     	0 流時 CB_SETCURSEL    GetID: CbList_時 SendDlgItemMessage: self drop					
					then
					
                        IDOK                SetID: Button_確認
                        self                Start: Button_確認
                       380 405 星寬 星高     Move: Button_確認
        ...
        \ 午宮
                ...
                星名_午_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_午_25
                                50 125 星寬 星高   Move: 星位_午_25
                                星名_午_25 count SetText: 星位_午_25
                                               GetStyle: 星位_午_25
                                BS_DEFPUSHBUTTON +Style: 星位_午_25
                        then
                星名_午_21 1 + c@ 0 <>
                        if id_星位_午_21 SetID: 星位_午_21
                                self              Start: 星位_午_21
                                0 100 星寬 星高    Move: 星位_午_21
                                星名_午_21 count SetText: 星位_午_21
                                               GetStyle: 星位_午_21
                                BS_DEFPUSHBUTTON +Style: 星位_午_21
                        then
                星名_午_22 1 + c@ 0 <>
                        if id_星位_午_22 SetID: 星位_午_22
                        self                      Start: 星位_午_22
                                0 125 星寬 星高   Move: 星位_午_22
                                星名_午_22 count SetText: 星位_午_22
                                               GetStyle: 星位_午_22
                                BS_DEFPUSHBUTTON +Style: 星位_午_22
                        then
        ...
        \ 未宮
                ...
                星名_未_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_未_25
                                200 125 星寬 星高   Move: 星位_未_25
                                星名_未_25 count SetText: 星位_未_25
                                               GetStyle: 星位_未_25
                                BS_DEFPUSHBUTTON +Style: 星位_未_25
                        then
                星名_未_21 1 + c@ 0 <>
                        if id_星位_未_21 SetID: 星位_未_21
                                self              Start: 星位_未_21
                                150 100 星寬 星高    Move: 星位_未_21
                                星名_未_21 count SetText: 星位_未_21
                                               GetStyle: 星位_未_21
                                BS_DEFPUSHBUTTON +Style: 星位_未_21
                        then
                星名_未_22 1 + c@ 0 <>
                        if id_星位_未_25 SetID: 星位_未_22
                        self                      Start: 星位_未_22
                                150 125 星寬 星高   Move: 星位_未_22
                                星名_未_22 count SetText: 星位_未_22
                                               GetStyle: 星位_未_22
                                BS_DEFPUSHBUTTON +Style: 星位_未_22
                        then
        ...
        \ 申宮
                ...
                星名_申_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_申_25
                                350 125 星寬 星高   Move: 星位_申_25
                                星名_申_25 count SetText: 星位_申_25
                                               GetStyle: 星位_申_25
                                BS_DEFPUSHBUTTON +Style: 星位_申_25
                        then
                星名_申_21 1 + c@ 0 <>
                        if id_星位_申_21 SetID: 星位_申_21
                                self              Start: 星位_申_21
                                300 100 星寬 星高    Move: 星位_申_21
                                星名_申_21 count SetText: 星位_申_21
                                               GetStyle: 星位_申_21
                                BS_DEFPUSHBUTTON +Style: 星位_申_21
                        then
                星名_申_22 1 + c@ 0 <>
                        if id_星位_申_25 SetID: 星位_申_22
                        self                      Start: 星位_申_22
                                300 125 星寬 星高   Move: 星位_申_22
                                星名_申_22 count SetText: 星位_申_22
                                               GetStyle: 星位_申_22
                                BS_DEFPUSHBUTTON +Style: 星位_申_22
                        then
        \ 酉宮
                星名_酉_1 1 + c@ 0 <>
                        if id_星位_酉_1 SetID: 星位_酉_1
                        self                      Start: 星位_酉_1
                                450 0 星寬 星高     Move: 星位_酉_1
                ...
                星名_酉_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_酉_25
                                500 125 星寬 星高   Move: 星位_酉_25
                                星名_酉_25 count SetText: 星位_酉_25
                                               GetStyle: 星位_酉_25
                                BS_DEFPUSHBUTTON +Style: 星位_酉_25
                        then
                星名_酉_21 1 + c@ 0 <>
                        if id_星位_酉_21 SetID: 星位_酉_21
                                self              Start: 星位_酉_21
                                450 100 星寬 星高    Move: 星位_酉_21
                                星名_酉_21 count SetText: 星位_酉_21
                                               GetStyle: 星位_酉_21
                                BS_DEFPUSHBUTTON +Style: 星位_酉_21
                        then
                星名_酉_22 1 + c@ 0 <>
                        if id_星位_酉_22 SetID: 星位_酉_22
                        self                      Start: 星位_酉_22
                                450 125 星寬 星高   Move: 星位_酉_22
                                星名_酉_22 count SetText: 星位_酉_22
                                               GetStyle: 星位_酉_22
                                BS_DEFPUSHBUTTON +Style: 星位_酉_22
                        then
        \ 戌宮
                星名_戌_1 1 + c@ 0 <>
                        if id_星位_戌_1 SetID: 星位_戌_1
                        self                      Start: 星位_戌_1
                                450 150 星寬 星高   Move: 星位_戌_1
                ...
                星名_戌_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_戌_25
                                500 275 星寬 星高   Move: 星位_戌_25
                                星名_戌_25 count SetText: 星位_戌_25
                                               GetStyle: 星位_戌_25
                                BS_DEFPUSHBUTTON +Style: 星位_戌_25
                        then
                星名_戌_21 1 + c@ 0 <>
                        if id_星位_戌_21 SetID: 星位_戌_21
                                self              Start: 星位_戌_21
                                450 250 星寬 星高    Move: 星位_戌_21
                                星名_戌_21 count SetText: 星位_戌_21
                                               GetStyle: 星位_戌_21
                                BS_DEFPUSHBUTTON +Style: 星位_戌_21
                        then
                星名_戌_22 1 + c@ 0 <>
                        if id_星位_戌_22 SetID: 星位_戌_22
                        self                      Start: 星位_戌_22
                                450 275 星寬 星高   Move: 星位_戌_22
                                星名_戌_22 count SetText: 星位_戌_22
                                               GetStyle: 星位_戌_22
                                BS_DEFPUSHBUTTON +Style: 星位_戌_22
                        then
        \ 亥宮
                星名_亥_1 1 + c@ 0 <>
                        if id_星位_亥_1 SetID: 星位_亥_1
                        self                      Start: 星位_亥_1
                                450 300 星寬 星高   Move: 星位_亥_1
                ...
                星名_亥_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_亥_25
                                500 425 星寬 星高   Move: 星位_亥_25
                                星名_亥_25 count SetText: 星位_亥_25
                                               GetStyle: 星位_亥_25
                                BS_DEFPUSHBUTTON +Style: 星位_亥_25
                        then
                星名_亥_21 1 + c@ 0 <>
                        if id_星位_亥_21 SetID: 星位_亥_21
                                self              Start: 星位_亥_21
                                450 400 星寬 星高    Move: 星位_亥_21
                                星名_亥_21 count SetText: 星位_亥_21
                                               GetStyle: 星位_亥_21
                                BS_DEFPUSHBUTTON +Style: 星位_亥_21
                        then
                星名_亥_22 1 + c@ 0 <>
                        if id_星位_亥_22 SetID: 星位_亥_22
                        self                      Start: 星位_亥_22
                                450 425 星寬 星高   Move: 星位_亥_22
                                星名_亥_22 count SetText: 星位_亥_22
                                               GetStyle: 星位_亥_22
                                BS_DEFPUSHBUTTON +Style: 星位_亥_22
                        then
        ...
        \ 子宮
                ...
                星名_子_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_子_25
                                500 575 星寬 星高   Move: 星位_子_25
                                星名_子_25 count SetText: 星位_子_25
                                               GetStyle: 星位_子_25
                                BS_DEFPUSHBUTTON +Style: 星位_子_25
                        then
                星名_子_21 1 + c@ 0 <>
                        if id_星位_子_21 SetID: 星位_子_21
                                self              Start: 星位_子_21
                                450 550 星寬 星高    Move: 星位_子_21
                                星名_子_21 count SetText: 星位_子_21
                                               GetStyle: 星位_子_21
                                BS_DEFPUSHBUTTON +Style: 星位_子_21
                        then
                星名_子_22 1 + c@ 0 <>
                        if id_星位_子_22 SetID: 星位_子_22
                        self                      Start: 星位_子_22
                                450 575 星寬 星高   Move: 星位_子_22
                                星名_子_22 count SetText: 星位_子_22
                                               GetStyle: 星位_子_22
                                BS_DEFPUSHBUTTON +Style: 星位_子_22
                        then
        \ 丑宮
                星名_丑_1 1 + c@ 0 <>
                        if
                ...
                星名_丑_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_丑_25
                                350 575 星寬 星高   Move: 星位_丑_25
                                星名_丑_25 count SetText: 星位_丑_25
                                               GetStyle: 星位_丑_25
                                BS_DEFPUSHBUTTON +Style: 星位_丑_25
                        then
                星名_丑_21 1 + c@ 0 <>
                        if id_星位_丑_21 SetID: 星位_丑_21
                                self              Start: 星位_丑_21
                                300 550 星寬 星高    Move: 星位_丑_21
                                星名_丑_21 count SetText: 星位_丑_21
                                               GetStyle: 星位_丑_21
                                BS_DEFPUSHBUTTON +Style: 星位_丑_21
                        then
                星名_丑_22 1 + c@ 0 <>
                        if id_星位_丑_22 SetID: 星位_丑_22
                        self                      Start: 星位_丑_22
                                300 575 星寬 星高   Move: 星位_丑_22
                                星名_丑_22 count SetText: 星位_丑_22
                                               GetStyle: 星位_丑_22
                                BS_DEFPUSHBUTTON +Style: 星位_丑_22
                        then
        \ 寅宮
                星名_寅_1 1 + c@ 0 <>
                        if
                ...
                星名_寅_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_寅_25
                                200 575 星寬 星高   Move: 星位_寅_25
                                星名_寅_25 count SetText: 星位_寅_25
                                               GetStyle: 星位_寅_25
                                BS_DEFPUSHBUTTON +Style: 星位_寅_25
                        then
                星名_寅_21 1 + c@ 0 <>
                        if id_星位_寅_21 SetID: 星位_寅_21
                                self              Start: 星位_寅_21
                                150 550 星寬 星高    Move: 星位_寅_21
                                星名_寅_21 count SetText: 星位_寅_21
                                               GetStyle: 星位_寅_21
                                BS_DEFPUSHBUTTON +Style: 星位_寅_21
                        then
                星名_寅_22 1 + c@ 0 <>
                        if id_星位_寅_22 SetID: 星位_寅_22
                        self                      Start: 星位_寅_22
                                150 575 星寬 星高   Move: 星位_寅_22
                                星名_寅_22 count SetText: 星位_寅_22
                                               GetStyle: 星位_寅_22
                                BS_DEFPUSHBUTTON +Style: 星位_寅_22
                        then  
        \ 卯宮
                星名_卯_1 1 + c@ 0 <>
                        if
                ...
                星名_卯_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_卯_25
                                50 575 星寬 星高   Move: 星位_卯_25
                                星名_卯_25 count SetText: 星位_卯_25
                                               GetStyle: 星位_卯_25
                                BS_DEFPUSHBUTTON +Style: 星位_卯_25
                        then
                星名_卯_21 1 + c@ 0 <>
                        if id_星位_卯_21 SetID: 星位_卯_21
                                self              Start: 星位_卯_21
                                0 550 星寬 星高    Move: 星位_卯_21
                                星名_卯_21 count SetText: 星位_卯_21
                                               GetStyle: 星位_卯_21
                                BS_DEFPUSHBUTTON +Style: 星位_卯_21
                        then
                星名_卯_22 1 + c@ 0 <>
                        if id_星位_卯_22 SetID: 星位_卯_22
                        self                      Start: 星位_卯_22
                                0 575 星寬 星高   Move: 星位_卯_22
                                星名_卯_22 count SetText: 星位_卯_22
                                               GetStyle: 星位_卯_22
                                BS_DEFPUSHBUTTON +Style: 星位_卯_22
                        then
        \ 辰宮
                星名_辰_1 1 + c@ 0 <>
                        if
                ...
                星名_辰_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_辰_25
                                50 425 星寬 星高   Move: 星位_辰_25
                                星名_辰_25 count SetText: 星位_辰_25
                                               GetStyle: 星位_辰_25
                                BS_DEFPUSHBUTTON +Style: 星位_辰_25
                        then
                星名_辰_21 1 + c@ 0 <>
                        if id_星位_辰_21 SetID: 星位_辰_21
                                self              Start: 星位_辰_21
                                0 400 星寬 星高    Move: 星位_辰_21
                                星名_辰_21 count SetText: 星位_辰_21
                                               GetStyle: 星位_辰_21
                                BS_DEFPUSHBUTTON +Style: 星位_辰_21
                        then
                星名_辰_22 1 + c@ 0 <>
                        if id_星位_辰_22 SetID: 星位_辰_22
                        self                      Start: 星位_辰_22
                                0 425 星寬 星高   Move: 星位_辰_22
                                星名_辰_22 count SetText: 星位_辰_22
                                               GetStyle: 星位_辰_22
                                BS_DEFPUSHBUTTON +Style: 星位_辰_22
                        then
        \ 巳宮
                星名_巳_1 1 + c@ 0 <>
                        if
                ...
                星名_巳_25 1 + c@ 0 <>
                        ...
                        self                      Start: 星位_巳_25
                                50 275 星寬 星高   Move: 星位_巳_25
                                星名_巳_25 count SetText: 星位_巳_25
                                               GetStyle: 星位_巳_25
                                BS_DEFPUSHBUTTON +Style: 星位_巳_25
                        then
                星名_巳_21 1 + c@ 0 <>
                        if id_星位_巳_21 SetID: 星位_巳_21
                                self              Start: 星位_巳_21
                                0 275 星寬 星高    Move: 星位_巳_21
                                星名_巳_21 count SetText: 星位_巳_21
                                               GetStyle: 星位_巳_21
                                BS_DEFPUSHBUTTON +Style: 星位_巳_21
                        then
                星名_巳_22 1 + c@ 0 <>
                        if id_星位_巳_22 SetID: 星位_巳_22
                        self                      Start: 星位_巳_22
                                0 250 星寬 星高   Move: 星位_巳_22
                                星名_巳_22 count SetText: 星位_巳_22
                                               GetStyle: 星位_巳_22
                                BS_DEFPUSHBUTTON +Style: 星位_巳_22
                        then
		...
		: 生時輸入		
					0 0 CB_GETCURSEL GETID: CbList_紀元 SendDlgItemMessage: self
					case
						2	of	年歲	endof
						1	of	民國	endof
						0	of	西元	endof
					...
					0 0 CB_GETCURSEL GETID: CbList_千年 SendDlgItemMessage: self dup to 千年 10 *
					0 0 CB_GETCURSEL GETID: CbList_百年 SendDlgItemMessage: self dup to 百年 + 10 *              
					0 0 CB_GETCURSEL GETID: CbList_十年 SendDlgItemMessage: self dup to 十年 + 10 * 
					0 0 CB_GETCURSEL GETID: CbList_年 	SendDlgItemMessage: self dup to 年  + 				
				\	
					紀元
					case
						民國	of	72 -				endof
					...
					0 0 CB_GETCURSEL GETID: CbList_曆法 SendDlgItemMessage: self to 曆法
					0 0 CB_GETCURSEL GETID: CbList_月 SendDlgItemMessage: self to 月
					0 0 CB_GETCURSEL GETID: CbList_日 SendDlgItemMessage: self to 日
					0 0 CB_GETCURSEL GETID: CbList_時 SendDlgItemMessage: self to 時
					0 0 CB_GETCURSEL GETID: CbList_男女 SendDlgItemMessage: self to 男女						
\			曆法
\			case
...
\			endcase			
		...
		: 流時輸入
				\ 
					...
					0 0 CB_GETCURSEL GETID: CbList_千年 SendDlgItemMessage: self dup to 流千年 10 *
					0 0 CB_GETCURSEL GETID: CbList_百年 SendDlgItemMessage: self dup to 流百年 + 10 *              
					0 0 CB_GETCURSEL GETID: CbList_十年 SendDlgItemMessage: self dup to 流十年 + 10 * 
					0 0 CB_GETCURSEL GETID: CbList_年 	SendDlgItemMessage: self dup to 流年  + 				
				\	
					流紀元
					case
						民國	of	72 -				endof
					...
					endcase
						...
						地支調整 to 流年的地支
						流年花甲 生年花甲 - 1 + to 歲數						
					0 0 CB_GETCURSEL GETID: CbList_曆法 SendDlgItemMessage: self to 流曆法
					0 0 CB_GETCURSEL GETID: CbList_月 SendDlgItemMessage: self to 流月
					0 0 CB_GETCURSEL GETID: CbList_日 SendDlgItemMessage: self to 流日子
					0 0 CB_GETCURSEL GETID: CbList_時 SendDlgItemMessage: self to 流時
					流月 3 + to 流月的地支
					流日子 1 + to 流日
					流時 1 + to 流時的地支		 
			;
        ...
        :M WM_COMMAND   ( hwnd msg wparam lparam -- res )
				...
				IDOK 	of
							ID_命盤
							case
								本命命盤 of 本命命盤處理 endof
								大限命盤 of 大限命盤處理 endof									
								小限命盤 of 小限命盤處理 endof								
								流年命盤 of 流年命盤處理 endof								
								流月命盤 of 流月命盤處理 endof
								流日命盤 of 流日命盤處理 endof
								流時命盤 of 流時命盤處理 endof								
							endcase	
						endof
...
\ 					id_星位_亥_23  	of	 星名_亥_23 星情釋文	endof
 ...
 \					id_星位_亥_25  	of	 星名_亥_25 星情釋文	endof
                      ...
                      \  150 150  450 450 LTMAGENTA FillArea: dc
						...
						350 290
							...
							if
								...
								if
									s" 現在年齡:" temp$ place
									get-local-time time-buf w@  1911 - 72 - 生年花甲 - 1 +
									0 <# # # # #> temp$ +place	
								else
									s" 流年年齡:" temp$ place 
									歲數 0 <# # # # #> temp$ +place	
        ...
        :M WindowTitle: ( -- title )
        	ID_命盤 
        	case
                本命命盤 of z" 本命命盤" endof 
                大限命盤 of z" 大限命盤" endof                
                小限命盤 of z" 小限命盤" endof                 
                流年命盤 of z" 流年命盤" endof
                流月命盤 of z" 流月命盤" endof 
                流日命盤 of z" 流日命盤" endof
                流時命盤 of z" 流時命盤" endof 
            endcase               
        	;M 
