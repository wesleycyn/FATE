...
MenuBar 小限選單
 ...
 endbar		
	...
	:OBJECT 小限命盤視窗 <SUPER Window
        :M On_Init:     ( -- )

                self                Start: Group_1
                175 300 265 120         Move: Group_1
                s" 小限變更"        SetText: Group_1
